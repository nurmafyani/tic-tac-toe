...
import { checkResult } from '../../../actions/resultAction.js'
		...
		<div className="mt-4">
			<div className="col">
				<p>
					...
					{players.turn === 'p1'? <span className="badge-play b-player1">Player 1</span> : <span className="badge-play b-player2">Player 2</span>}
				</p>
